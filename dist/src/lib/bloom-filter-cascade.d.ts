 ...
 */
export declare function constructBFC(validIds: Set<string>, revokedIds: Set<string>, rHat: number): [BloomFilter[], string];
/**
 ...
 */
export declare function isInBFC(value: string, bfc: BloomFilter[], salted: string): boolean;
/**
 ...
 */
export declare function toDataHexString(bfc: [BloomFilter[], string]): string;
/**
 ...
 */
export declare function fromDataHexString(serialized: string): [BloomFilter[], string];
//# sourceMappingURL=bloom-filter-cascade.d.ts.map